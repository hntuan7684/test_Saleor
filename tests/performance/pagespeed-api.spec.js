...
test.describe('PS001 - Home Page Performance Tests', () => {
  // const baseUrl = 'https://storefront-dev.mypodsoftware.io.vn/us';

  test('should pass PageSpeed Insights test for desktop', async () => {
    // Skip test if no API key
    if (!process.env.PAGESPEED_API_KEY) {
      console.log('Skipping PageSpeed test - no API key provided');
      return;
    }
...
test.describe('PS002 - Service Page Performance Tests', () => {
  // const serviceUrl = 'https://storefront-dev.mypodsoftware.io.vn/us/service';
...
test.describe('PS003 - Products Page Performance Tests', () => {
  // const productsUrl = 'https://storefront-dev.mypodsoftware.io.vn/us/products';
...
test.describe('PS004 - Support Page Performance Tests', () => {
  // const supportUrl = 'https://storefront-dev.mypodsoftware.io.vn/us/support';
...
test.describe('PS005 - Login Page Performance Tests', () => {
  // const loginUrl = 'https://accounts.mypodsoftware.io.vn/realms/keycloak/protocol/openid-connect/auth?response_type=code&client_id=zoomprints-saleor-client&redirect_uri=https%3A%2F%2Fstorefront-dev.mypodsoftware.io.vn%2Fus%2Fauth%2Fkeycloak-callback&scope=openid+profile+email+offline_access&state=eyJyZWRpcmVjdFVyaSI6Imh0dHBzOi8vc3RvcmVmcm9udC1kZXYubXlwb2Rzb2Z0d2FyZS5pby52bi91cy9hdXRoL2tleWNsb2FrLWNhbGxiYWNrfQ%3D%3D';
...
test.describe('PS006 - Authenticated Product Detail Page Performance Tests', () => {
  test.beforeEach(async ({ page }) => {
    ...
    await loginPage.login(process.env.TEST_EMAIL || "test@example.com", process.env.TEST_PASSWORD || "testpassword123");
    await expect(
